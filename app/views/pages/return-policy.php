...
<head>
    ...
    <title>Chính sách đổi trả - Flower Shop</title>
...
<body>
    ...
    <div class="policy-container">
        ...
        <div class="policy-content">
            ...
            <p>Flower Shop chấp nhận đổi trả sản phẩm trong các trường hợp sau:</p>
            <ul>
            ...
            <ul>
                ...
                <li>Email: contact@flowershop.vn</li>
            ...
            <p><strong>Hoàn toàn miễn phí</strong> - Flower Shop chịu toàn bộ chi phí trong trường hợp sản phẩm lỗi do chúng tôi.</p>
            ...
            <div class="highlight-box">
                ...
                Mọi thắc mắc về chính sách đổi trả, vui lòng liên hệ hotline 1900 1234 hoặc email contact@flowershop.vn
            </div>
        </div>
    </div>
